...
SiteCovs["biomass_tt"] <- c(SiteCovs$photoRates_biomass.x+SiteCovs$photoRates_biomass.y)
SiteCovs
...
##de detecção foi gerado o modelo para avaliar, ao considerar eletavion na esta analise de deteccao o efeito do bloco estaria contemplado
##(porém, talvez o mais acertado seja considerar bloco como efeito aleatorio - GLMM - vou analisar isso nos proximos dias)
...
##no modelo para analisar apenas a deteccao da onca, mantive a occupacao (psi) sem os efeitos das covariaveis
### e a deteccao (p) com os efeitos das covariaveis
...
params <- c("alpha.psi", "beta1.p", "beta2.p", "beta3.p", "beta5.p", "beta7.p","beta8.p","mean.p", "occ.fs", "alpha.p", "z", "mu.p")
