...
Ptajacu2017 <- readRDS(here("data", "Ptajacu_2017team.rds")) 
y <- Ptajacu2017[,2:15]
y
SiteCovs <- Ptajacu2017[,16:23]
...
# Bundle data
dataJAGS <- list(y = y, R = nrow(y), T = ncol(y), distWater=distWater, distEdge=distEdge, basalArea=basalArea, elevation=elevation)
...
params <- c("alpha.psi", "beta1.psi", "beta3.psi", "beta2.psi", "beta5.psi", "mean.p", "occ.fs", "alpha.p", "z")
